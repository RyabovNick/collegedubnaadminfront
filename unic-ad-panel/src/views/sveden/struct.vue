  ...
  <v-app>
    ...
    <v-expansion-panel>
      <v-expansion-panel-content>
        ...
        <v-card>
          <v-card-text>На странице можно добавить информацию в раздел "Структура и органы управления образовательной организацией" и "Руководство. Педагогический (научно-педагогический) состав". В разделах, по требованиям министерства, находится одинаковая (частично) информация.</v-card-text>
        </v-card>
      </v-expansion-panel-content>
    </v-expansion-panel>
