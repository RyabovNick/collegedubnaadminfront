  ...
  <v-app>
    ...
    <v-expansion-panel>
      <v-expansion-panel-content>
        ...
        <v-card>
          <v-card-text>
            На странице можно добавить информацию в раздел "Образование" подраздел "Информация о численности обучающихся по реализуемым образовательным программам".
