    ...
    <v-container fluid grid-list-xl>
      <v-expansion-panel>
        <v-expansion-panel-content>
          ...
          <v-card>
            <v-card-text>
              На странице можно добавлять новости на главную.
              <br>Для добавления новой новости:
              <ol>
                <li>Ничего не выбирайте в "Выбор страницы"</li>
                <li>Выберите необходимый ранк. Новости сортируются по: ранку (от меньшего к большему), затем по дате добавления. Т.е. если вам нужно закрепить в новостях какую-то новость поставьте ранк, например, 6.</li>
                <li>Укажите заголовок новости.</li>
                <li>Дата захода на страницу, но если надо другое время - пожалуйста :D</li>
                <li>Справа ещё необходимо выбрать лого для новости, размер (....)</li>
                <li>Для содержания новости используется markdown - можно почитать в интернете. Тут удобный редактор, справа от которого показано, как будет выглядеть страница на сайте.</li>
                <li>Если всё хорошо - нажмите на синюю кнопку "Добавить новость". Добавление галлерии или документов (снизу новости) - осуществляются на отдельной странице "Добавить фото к новостям".</li>
              </ol>
              <br>Для изменения новости:
              <ol>
                <li>Выберите нужную новость в "Выбор страницы"</li>
                <li>Внесите необходимые изменения</li>
                <li>Нажмите на синюю кнопку "Изменить новость"</li>
              </ol>
              <br>Для удаления новости:
              <ol>
                <li>Выберите нужную новость в "Выбор страницы"</li>
                <li>Нажмите на красную кнопку "Удалить новость"</li>
              </ol>
            </v-card-text>
          </v-card>
        </v-expansion-panel-content>
